...
export function getInterpretationRule(lines: LineResult[]): InterpretationResult {
  ...
  switch (count) {
    case 0:
      return {
        type: 'hexagram-only',
        description: '변효 없음 — 본괘의 괘사만 해석해요.',
    ...
    case 1:
      return {
        type: 'single-line',
        description: `변효 1개(${changingPositions[0]}효) — 해당 변효의 효사를 해석해요.`,
        primaryHexagram: 'original',
    ...
    case 2: {
      ...
      return {
        type: 'double-line',
        description: `변효 2개(${sorted[1]}효, ${sorted[0]}효) — 상위 효(${sorted[0]}효) 효사를 우선 해석해요.`,
        primaryHexagram: 'original',
    ...
    case 3:
      return {
        type: 'both-hexagrams',
        description: '변효 3개 — 본괘와 변괘의 괘사를 함께 해석해요.',
        primaryHexagram: 'original',
        highlightedLines: changingPositions,
      };
    ...
    case 4: {
      ...
      return {
        ...
        description: `변효 4개 — 변괘 기준 고정 효(${fixedPositions.join(', ')}효) 2개의 효사를 해석해요.`,
    ...
    case 5: {
      ...
      return {
        ...
        description: `변효 5개 — 변괘 기준 고정 효(${fixedPositions[0]}효) 1개의 효사를 해석해요.`,
        primaryHexagram: 'changing',
        highlightedLines: fixedPositions,
      };
    }
    ...
    case 6:
      return {
        ...
        description: '변효 6개(전변) — 변괘의 괘사만 해석해요.',
        primaryHexagram: 'changing',
        highlightedLines: [],
      };
